...
## Work Experience
**Data Scietist @ Braebon (_July 2025_ - _Feb 2026_)**
- Employed numerical optimization techniques to refine the core parameters of a biomedical estimation model, boosting its predictive performance by 20%.
-	Created interactive dashboards using Streamlit to visualize model outputs based on data-driven performance metrics, improving stakeholder understanding and engagement.
-	Develop and maintain a fully automated end-to-end data pipeline, integrating preprocessing, model inference, and visualization, reducing manual intervention by 15%.
-	Applied hyperparameter tuning and cross-validation to improve model robustness and generalization by 10%.
...
4. Maryam Hayati, Farahani, M.H.D., SAR image despeckling based on sparse representation and structural features of image patches, 1st scientific research conference on Mechanics, Electrical, and Computer Engineering, Baku. 2020
